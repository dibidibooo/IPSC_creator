...
Sidebar.Geometry.CylinderGeometry = function ( editor, object ) {
	...
	radiusTopRow.add( new UI.Text( 'Верхний радиус' ).setWidth( '90px' ) );
	...
	radiusBottomRow.add( new UI.Text( 'Нижний радиус' ).setWidth( '90px' ) );
	...
	radialSegmentsRow.add( new UI.Text( 'Радиальные сегменты' ).setWidth( '90px' ) );
	...
	openEndedRow.add( new UI.Text( 'Сквозной' ).setWidth( '90px' ) );
