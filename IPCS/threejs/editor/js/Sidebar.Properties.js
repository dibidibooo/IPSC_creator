...
Sidebar.Properties = function ( editor ) {
	...
	var objectTab = new UI.Text( 'ОБЪЕКТ' ).onClick( onClick );
	var geometryTab = new UI.Text( 'ГЕОМЕТРИЯ' ).onClick( onClick );
	var materialTab = new UI.Text( 'МАТЕРИАЛ' ).onClick( onClick );
