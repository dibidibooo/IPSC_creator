...
Sidebar.Scene = function ( editor ) {
	...
	fogNearRow.add( new UI.Text( 'Туман рядом' ).setWidth( '90px' ) );
	...
	fogFarRow.add( new UI.Text( 'Туман далеко' ).setWidth( '90px' ) );
	...
	fogDensityRow.add( new UI.Text( 'Плотность тумана' ).setWidth( '90px' ) );
