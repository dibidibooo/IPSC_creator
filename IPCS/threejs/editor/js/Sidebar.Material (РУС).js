...
Sidebar.Material = function ( editor ) {
	...
	managerRow.add( new UI.Text( '' ).setWidth( '20px' ) );
	managerRow.add( new UI.Button( 'Новый' ).onClick( function () {

		var material = new THREE[ materialClass.getValue() ]();
		editor.execute( new SetMaterialCommand( currentObject, material ), 'Новый материал: ' + materialClass.getValue() );
		update();

	} ) );

	managerRow.add( new UI.Button( 'Копировать' ).onClick( function () {

		copiedMaterial = currentObject.material;

	} ) );

	managerRow.add( new UI.Button( 'Вставить' ).onClick( function () {

		if ( copiedMaterial === undefined ) return;

		editor.execute( new SetMaterialCommand( currentObject, copiedMaterial ), 'Вставленный материал: ' + materialClass.getValue() );
		refreshUI();
		update();
	...
	materialClassRow.add( new UI.Text( 'Тип' ).setWidth( '90px' ) );
	...
	materialNameRow.add( new UI.Text( 'Название' ).setWidth( '90px' ) );
	...
	materialProgramRow.add( new UI.Text( 'Программма' ).setWidth( '90px' ) );

	var materialProgramInfo = new UI.Button( 'Инфо' );
	...
	var materialProgramVertex = new UI.Button( 'Вершина' );
	...
	var materialProgramFragment = new UI.Button( 'Фрагмент' );
	...
	materialColorRow.add( new UI.Text( 'Цвет' ).setWidth( '90px' ) );
	...
	materialRoughnessRow.add( new UI.Text( 'Шероховатость' ).setWidth( '90px' ) );
	...
	materialMetalnessRow.add( new UI.Text( 'Металл' ).setWidth( '90px' ) );
	...
	materialEmissiveRow.add( new UI.Text( 'Выделение' ).setWidth( '90px' ) );
	...
	materialSpecularRow.add( new UI.Text( 'Зеркальный' ).setWidth( '90px' ) );
	...
	materialShininessRow.add( new UI.Text( 'Блеск' ).setWidth( '90px' ) );
	...
	materialVertexColorsRow.add( new UI.Text( 'Цвета вершин' ).setWidth( '90px' ) );
	...
	materialSkinningRow.add( new UI.Text( 'Без поверхности' ).setWidth( '90px' ) );
	...
	materialSideRow.add( new UI.Text( 'Сторона' ).setWidth( '90px' ) );
	...
	materialShadingRow.add( new UI.Text( 'Тени' ).setWidth( '90px' ) );
	...
	materialBlendingRow.add( new UI.Text( 'Смешивание' ).setWidth( '90px' ) );
	...
	materialOpacityRow.add( new UI.Text( 'Непрозрачность' ).setWidth( '90px' ) );
	...
	materialTransparentRow.add( new UI.Text( 'Прозрачность' ).setWidth( '90px' ) );
	...
	materialWireframeRow.add( new UI.Text( 'Каркас' ).setWidth( '90px' ) );
	...
	function update() {
		...
		if ( textureWarning ) {
			...
			console.warn( "Невозможно установить текстуру, модель не имеет координат текстуры" );
