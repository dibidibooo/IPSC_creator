...
Viewport.Info = function ( editor ) {
	...
	container.add( new UI.Text( 'Объекты:' ), objectsText, new UI.Break() );
	container.add( new UI.Text( 'Вершины:' ), verticesText, new UI.Break() );
	container.add( new UI.Text( 'Треугольники:' ), trianglesText, new UI.Break() );
