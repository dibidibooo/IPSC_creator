...
Sidebar.Project = function ( editor ) {
	...
	rendererTypeRow.add( new UI.Text( 'Настройки рендера' ).setWidth( '90px' ) );
	...
	var rendererAntialias = new UI.THREE.Boolean( config.getKey( 'project/renderer/antialias' ), 'Сглаживание' ).onChange( function () {
	...
	var rendererShadows = new UI.THREE.Boolean( config.getKey( 'project/renderer/shadows' ), 'Визуализация теней' ).onChange( function () {
	...
	editableRow.add( new UI.Text( 'Редактируемый' ).setWidth( '90px' ) );
