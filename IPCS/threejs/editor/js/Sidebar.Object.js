...
Sidebar.Object = function ( editor ) {
	...
	objectTypeRow.add( new UI.Text( 'Тип' ).setWidth( '90px' ) );
	...
	objectNameRow.add( new UI.Text( 'Название' ).setWidth( '90px' ) );
	...
	*/
	...
	objectFovRow.add( new UI.Text( 'Диапазон' ).setWidth( '90px' ) );
	...
	objectNearRow.add( new UI.Text( 'Близко' ).setWidth( '90px' ) );
	...
	objectFarRow.add( new UI.Text( 'Далеко' ).setWidth( '90px' ) );
	...
	objectIntensityRow.add( new UI.Text( 'Интенсивность' ).setWidth( '90px' ) );
	...
	objectColorRow.add( new UI.Text( 'Цвет' ).setWidth( '90px' ) );
	...
	objectGroundColorRow.add( new UI.Text( 'Основной цвет' ).setWidth( '90px' ) );
	...
	objectDistanceRow.add( new UI.Text( 'Дистанция' ).setWidth( '90px' ) );
	...
	objectAngleRow.add( new UI.Text( 'Угол' ).setWidth( '90px' ) );
	...
	objectPenumbraRow.add( new UI.Text( 'Полутень' ).setWidth( '90px' ) );
	...
	objectDecayRow.add( new UI.Text( 'Разложение' ).setWidth( '90px' ) );
	...
	objectShadowRow.add( new UI.Text( 'Тень' ).setWidth( '90px' ) );

	var objectCastShadow = new UI.THREE.Boolean( false, 'Отбрасывать тень' ).onChange( update );
	objectShadowRow.add( objectCastShadow );

	var objectReceiveShadow = new UI.THREE.Boolean( false, 'Получить тень' ).onChange( update );
	...
	objectVisibleRow.add( new UI.Text( 'Видимость' ).setWidth( '90px' ) );
	...
	objectUserDataRow.add( new UI.Text( 'Данные пользователя' ).setWidth( '90px' ) );
